...
EyalGluDend = Glutamatergic(
		 Receptor(E_rev=0.0, τr=0.25, τd=2.0,g0=0.73, type="ampa"),
		 ReceptorVoltage(E_rev=0.0, τr = 8, τd=35., g0 = 1.31, type="nmda")
)
...
MilesGabaDend = GABAergic(
 Receptor(E_rev = -75.,τr= 4.8, τd= 29., g0= 0.126, type="gabaa"),
 Receptor(E_rev = -90.,τr= 30, τd= 100., g0=0.006, type="gabab")
)

MilesGabaSoma = GABAergic(
 Receptor(E_rev = -75.,τr= 0.5, τd= 6., g0= 0.265, type="gabaa"),
 Receptor()
)
...
DuarteGluSoma = Glutamatergic(
		 Receptor(E_rev=0.0, τr=0.25, τd=2.0,g0=0.73, type="ampa"),
		 ReceptorVoltage(E_rev=0.0, type="nmda"))
