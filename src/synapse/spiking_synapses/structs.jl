...
@snn_kw struct Receptor{T=Float32, TS=String}
	E_rev::T=0.0
	τr::T=-1.f0
	τd::T=-1.f0
	g0::T= 0.f0
	gsyn::T =  g0 > 0 ? g0*norm_synapse(τr,τd) : 0.f0
	α::T =  α_synapse(τr, τd)
	τr⁻::T= 1/τr > 0 ? 1/τr : 0.f0
	τd⁻::T=1/τd > 0 ? 1/τd : 0.f0
	type::TS="any"
end

ReceptorVoltage = Receptor
SynapseArray = Vector{Receptor}
