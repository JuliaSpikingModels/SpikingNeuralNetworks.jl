...
Input_I = SNN.Poisson(; N = N, param = SNN.PoissonParameter(; rate = 0.3νi))
E = SNN.AdEx(; N = NE, param = LKD_AdEx_exc)
I = SNN.IF(; N = NI, param = LKD_IF_inh)
