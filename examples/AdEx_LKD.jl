...
LKD_AdEx_exc =
    ...
    b = 0.000805nA, τw = 150ms, τre = τre, τde = τde, τri = τri, τdi = τdi, At = 10mV, τT = 30ms, E = 0mV)

LKD_IF_inh =
    IFParameter(τm = 20ms, Vt = -52mV, Vr = -60mV, El = -62mV, τre = τre, τde = τde, τri = τri, τdi = τdi, E = -75mV)
# LKD_AdEx_inh =
